...
import DEKTOPFOOTER from "../components/d-e-k-t-o-p-f-o-o-t-e-r";
  ...
  return (
    <>
      <div className="relative bg-darkolivegreen-600 w-full overflow-hidden flex flex-col items-center justify-start">
        ...
        <section className="self-stretch overflow-hidden flex flex-col items-center justify-start py-20 px-[229px] gap-[110px] bg-[url('/workwithframe@3x.png')] bg-cover bg-no-repeat bg-[top] lg:items-start lg:justify-center lg:p-[15px] lg:box-border md:gap-[30px]">
          <section className="self-stretch flex flex-row items-start justify-start py-[30px] px-0 gap-[45px] lg:hidden">
            <FrameComponent6 />
            <CONTACTFORM />
          </section>
          <section className="w-[819px] h-[1237px] hidden flex-col items-start justify-start py-0 px-[150px] box-border gap-[20px] text-left text-41xl text-goldenrod-100 font-poppins lg:flex lg:items-center lg:justify-start lg:py-2.5 lg:px-[90px] lg:box-border md:flex">
            ...
            <div className="self-stretch rounded-18xl bg-whitesmoke-200 overflow-hidden flex flex-col items-center justify-start py-[19px] px-[18px] gap-[35px] text-base text-gray-1200 border-[1px] border-solid border-gray-200">
              ...
              <div className="self-stretch flex flex-row items-end justify-start text-center text-lg text-gray-300">
                ...
                <div className="flex-1 relative rounded-xl box-border h-[45px] border-[1px] border-solid border-seagreen-300">
                  <div className="absolute top-[5.7px] left-[4.2px] tracking-[0.04em]">
                    New Business
                  </div>
                  <div className="absolute h-[calc(100%_-_25px)] w-[calc(100%_-_157px)] top-[-0.3px] right-[171px] bottom-[25.3px] left-[-14px] [transform:_rotate(180deg)] [transform-origin:0_0]" />
                </div>
