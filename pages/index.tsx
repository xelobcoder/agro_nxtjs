  ...
  return (
    <>
      <div className="relative bg-darkolivegreen-500 w-full overflow-hidden flex flex-col items-center justify-start text-left text-[76px] text-goldenrod-100 font-poppins">
        <header className="self-stretch bg-gray-1300 [backdrop-filter:blur(200px)] flex flex-col items-center justify-start">
          <nav
...
We provide an ecosystem for all the players in the agricultural supply chain. `}</div>
          ...
          <section className="w-[352.5px] overflow-hidden hidden flex-col items-start justify-start pt-10 px-[33.04938507080078px] pb-5 box-border gap-[10px] bg-[url('/350@3x.png')] bg-cover bg-no-repeat bg-[top] text-left text-11xl text-white font-poppins mq350small:flex">
...
We provide an ecosystem for all the players in the agricultural supply chain. `}</div>
        ...
        <section className="self-stretch flex flex-col items-center justify-start text-left text-sm-3 text-white font-poppins">
