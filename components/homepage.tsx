          ...
          >
            <div className="flex-1 flex flex-row items-center justify-between py-0 px-2.5">
              <div className="self-stretch rounded-[99px] bg-gray-800 [backdrop-filter:blur(250.6px)] w-40 flex flex-row items-center justify-start py-[5px] px-5 box-border gap-[14px]">
                ...
                <button className="cursor-pointer [border:none] p-0 bg-[transparent] self-stretch relative w-[27.7px] [&_.oursubsidiarylogos13]:hover:flex">
                  <div
                    className="oursubsidiarylogos13 absolute top-[1.1px] left-[35.1px] w-[314.9px] h-[23.1px] hidden"
                    id="ourSubsidiaries"
                  >
                    <img
          ...
          >
            <div className="flex-1 flex flex-row items-center justify-between">
              <div className="self-stretch rounded-[84.15px] bg-gray-800 [backdrop-filter:blur(213.01px)] w-[121.6px] flex flex-row items-center justify-center py-[4.25px] px-[17px] box-border gap-[11.9px]">
                ...
                <button className="cursor-pointer [border:none] p-0 bg-[transparent] self-stretch relative w-[23.5px] [&_.oursubsidiarylogos14]:hover:flex">
                  <div
                    className="oursubsidiarylogos14 absolute top-[0.9px] left-[29.8px] w-[267.6px] h-[19.6px] hidden"
                    id="ourSubsidiaries"
                  >
                    <img
