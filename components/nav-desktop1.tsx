    ...
    >
      <div className="self-stretch flex flex-row items-center justify-between">
        <div className="relative w-[125.7px] h-[42.7px]">
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[9px] left-[77px] w-[34.7px] h-[34.7px] [&_.oursubsidiarylogos18]:hover:flex">
            <div
              className="oursubsidiarylogos18 absolute top-[1.4px] left-[44px] w-[395px] h-[29px] hidden"
              id="ourSubsidiaries"
            >
              <img
