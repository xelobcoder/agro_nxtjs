...
const CONTACTFORM: NextPage = () => {
  ...
  return (
    <section
      className="flex-1 rounded-18xl bg-whitesmoke-200 overflow-hidden flex flex-col items-center justify-start py-[19px] px-[18px] gap-[35px] [&.animate]:animate-[1s_ease_0s_1_normal_forwards_fade-in] opacity-[0] text-left text-base text-gray-1200 font-poppins border-[1px] border-solid border-gray-200"
      data-animate-on-scroll
    >
      ...
      <div className="self-stretch flex flex-row items-end justify-start text-lg text-gray-300">
        ...
        <div className="flex-1 relative rounded-xl box-border h-[45px] border-[1px] border-solid border-seagreen-300">
          <div className="absolute top-[-11.3px] left-[119.5px] w-[22px] h-5">
            <img
              className="absolute top-[0px] left-[0px] w-[22px] h-5"
              alt=""
              src="/group-902.svg"
            />
      ...
      <div className="self-stretch rounded-10xl box-border h-16 overflow-hidden shrink-0 flex flex-row items-center justify-start py-3 px-[17px] text-sm border-[1px] border-solid border-darkslategray-600">
        <div className="flex-1 relative tracking-[0.04em]">Company</div>
      </div>
      <div className="self-stretch rounded-3xl box-border h-[157px] overflow-hidden shrink-0 flex flex-row items-start justify-start py-4 px-[27px] border-[1px] border-solid border-darkslategray-600">
        <div className="relative tracking-[0.04em]">Type your message here</div>
      </div>
